...
## Installation
Depending on your harness, will determine where the agent skills should live. For pi, copy agents to `~/.pi/agent/skills/plan-to-queue.md`. 
...
Then we can use the 'plan-for-queue' skill, this will generate a txt batch file. Which then we can load into
...
| [using large model] /skill:plan-to-que [plan.md]
